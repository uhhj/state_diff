...
Repository:
- Main start: ebd920067d917872b8e7360af1440c9fdb079cbc
- Main end: bc578caa4359a2a9122de67d6d63de4f9f139414
- Branch: Experiment3
- Clean before result: True
- Remote tip: bc578caa4359a2a9122de67d6d63de4f9f139414
...
- Future visible RMSE peak: 0.0038492195677593283 m
- Repeat floor: 0.0004646102384433032 m
- Future/repeat ratio: 8.284835867277282
- Future horizon extension: 144 -> 336 samples (0.5958333333333333 -> 1.3958333333333333 s sample interval span at 240 Hz)
- Added post-test observation: 192 samples / 0.8 s
- R9-prefix trajectory and command arrays exact for FREE/JAM/FREE-repeat: True
- R9 endpoint / R10 endpoint visible RMSE: 0.0026143672158800836 / 0.0038492195677593283 m
- R10 endpoint is the horizon-global maximum: True (index 335 / 335)
- Final 24-sample delta / fitted slope: 0.00016958311530309526 m / 0.0020515169398773207 m/s
- Final 48-sample delta / fitted slope: 3.7463449097385314e-05 m / 0.0002172664387095928 m/s
- Final 96-sample delta / fitted slope: 0.00037021586055592526 m / 0.00029402201746767624 m/s
- Future-horizon plateau at endpoint: False (descriptive audit only; benchmark gates unchanged)
- FREE/JAM extraction progress: {'free': 0.026362983513794014, 'free_repeat': 0.027128268854047344, 'jam_right': 0.03278931002909696}
- Repeat first phase above equivalence threshold: None
- Repeat phase diagnostics: [{'end_51d_rmse_m': 0.0, 'peak_51d_rmse_m': 0.0, 'peak_ee_rmse_m': 0.0, 'peak_keypoint_rmse_m': 0.0, 'phase': 'no_action', 'start_51d_rmse_m': 0.0}, {'end_51d_rmse_m': 0.0, 'peak_51d_rmse_m': 0.0, 'peak_ee_rmse_m': 0.0, 'peak_keypoint_rmse_m': 0.0, 'phase': 'probe_forward', 'start_51d_rmse_m': 0.0}, {'end_51d_rmse_m': 0.0, 'peak_51d_rmse_m': 0.0, 'peak_ee_rmse_m': 0.0, 'peak_keypoint_rmse_m': 0.0, 'phase': 'probe_hold', 'start_51d_rmse_m': 0.0}, {'end_51d_rmse_m': 0.0, 'peak_51d_rmse_m': 0.0, 'peak_ee_rmse_m': 0.0, 'peak_keypoint_rmse_m': 0.0, 'phase': 'probe_return', 'start_51d_rmse_m': 0.0}, {'end_51d_rmse_m': 8.041755786136942e-05, 'peak_51d_rmse_m': 8.113769519627918e-05, 'peak_ee_rmse_m': 0.00017243476014722596, 'peak_keypoint_rmse_m': 7.166885149027517e-05, 'phase': 'post_probe', 'start_51d_rmse_m': 0.0}, {'end_51d_rmse_m': 8.051824890159804e-05, 'peak_51d_rmse_m': 0.00033138578000013524, 'peak_ee_rmse_m': 0.00019053187456078368, 'peak_keypoint_rmse_m': 0.00034011900097921205, 'phase': 'test_pull', 'start_51d_rmse_m': 8.230614515579854e-05}, {'end_51d_rmse_m': 0.00040096842633337033, 'peak_51d_rmse_m': 0.00045075213083623086, 'peak_ee_rmse_m': 8.812532350077878e-05, 'peak_keypoint_rmse_m': 0.0004646102384433032, 'phase': 'post_test', 'start_51d_rmse_m': 8.068170865226452e-05}]
...
- Current: {'contact_reference_peak_excess_n': 0.3009355396283823, 'formal_sensor_peak_fused_gap': 2.6147160295345095, 'future_peak_visible_rmse_m': 0.0038492195677593283, 'post_probe_jam_latch_contact_fraction': 1.0, 'post_probe_rmse_m': 8.982128272931303e-05, 'probe_amplitude_m': 0.001, 'probe_delta_xyz_m': [0.0, -0.001, 0.0], 'probe_direction_unit': [0.0, -1.0, 0.0], 'probe_forward_steps': 24, 'probe_return_steps': 24, 'probe_speed_m_s': 0.01, 'proximal_excess_n': 0.24669686990680706, 'proximal_retention_ratio': 0.8197664862430233}
- Gain ratios: {'contact_reference_peak_excess': 0.9999386927806869, 'formal_sensor_peak': 7.832737866988331, 'future_peak': 1.4459016830887994, 'post_probe_jam_latch_contact_fraction': 1.0, 'post_probe_rmse': 1.353176691115959, 'probe_amplitude': 1.0, 'probe_speed': 1.0, 'proximal_excess': 11.129464549624506, 'proximal_retention': 11.130146907981981}
...
Next task: The orthogonal contact-loading probe makes the deployable sensor observable while preserving the observable-state gate. Freeze the R9 probe and 18D sensor. Do not continue probe-direction tuning; prepare the single-purpose same-action future-branch effect-size repair.
