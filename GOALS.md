...
> Current research checkpoint: Phase3.14b-r1.1 exact scheduler equivalence repair
> Current formal decision: **Phase3.14b-r1.1 is current; retraining and later phases remain blocked**
...
Phase3.14b-r1: COMPLETED / provisional scheduler-equivalence failure
Current: Phase3.14b-r1.1 Exact Diffusers-0.11.1 Scheduler Equivalence Repair
Phase3.14b-r2: BLOCKED pending r1.1
Phase3.14c IDM: BLOCKED
Phase4/CPS: BLOCKED
```

Phase3.13-r1 regenerated, audited, and atomically promoted the formal dataset under Commit A. Phase3.14a established the immutable training cache and passed the deterministic future learnability gate. Phase3.14b completed its full DDPM matrix but failed candidate physical validity. Phase3.14b-r1.1 now mirrors Diffusers 0.11.1 exactly and reaudits the same checkpoint without retraining. Phase3.14b-r2, Phase3.14c IDM, and Phase4/CPS remain blocked pending its result.
