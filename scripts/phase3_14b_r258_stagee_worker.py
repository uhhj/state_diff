#!/usr/bin/env python3
"""Isolated Phase3.14b-r2.5.8 Stage-E worker."""
...
def main() -> None:
    ...
    temporary_root = Path(
        tempfile.mkdtemp(prefix="phase314b_r258_stagee_", dir="/tmp")
    )
        ...
        json.dumps(
            {
                ...
                "contract_sha256": result["constrained_integrator_contract"]["contract_sha256"],
