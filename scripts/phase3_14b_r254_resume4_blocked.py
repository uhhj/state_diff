#!/usr/bin/env python3
"""Write-once operational failure evidence for Resume4."""
...
def main() -> None:
    ...
    summary = root / "reports/phase3_14b_r254_resume4_blocked_summary.json"
    markdown = root / "reports/phase3_14b_r254_resume4_blocked_report.md"
    final_summary = root / "reports/phase3_14b_r254_resume4_summary.json"
    if final_summary.exists() or summary.exists() or markdown.exists():
        return
    evidence = {}
    for relative in (
        "reports/phase3_14b_r254_resume4_test_gate_summary.json",
        "reports/phase3_14b_r254_resume4_preflight_summary.json",
        "reports/phase3_14b_r254_resume4_reproduction_audit_summary.json",
    ):
        path = root / relative
        if path.is_file():
    ...
    payload = {
        ...
        "verdict": "BLOCKED",
        "root_cause": "phase314b_r254_resume4_execution_failed",
    ...
    text = (
        "# Phase3.14b-r2.5.4 Resume4 Blocked\n\n"
        ...
        "No robot-proxy result is interpretable and no model is selected.\n"
    )
