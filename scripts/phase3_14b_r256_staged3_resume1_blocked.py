#!/usr/bin/env python3
"""Write-once blocked evidence for Stage D.3 Resume1."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=(
            "reports/"
            "phase3_14b_r256_staged3_resume1_blocked_summary.json"
        ),
    )
    ...
    payload = {
        ...
        "schema":
            "phase314b_r256_staged3_resume1_blocked_v1",
        "verdict": "BLOCKED",
        "scientific_status": "BLOCKED",
        "root_cause": (
            "phase314b_r256_staged3_resume1_"
