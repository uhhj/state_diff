#!/usr/bin/env python3
"""Write-once blocked evidence for Stage-A Portable Resume1."""
...
def main() -> None:
    ...
    payload = {
        ...
        "schema":
            "phase314b_r258_stagea_resume1_blocked_v1",
        "verdict": "BLOCKED",
        "scientific_status": "BLOCKED",
        "root_cause": (
            "phase314b_r258_stagea_resume1_"
        ...
        "failed_attempt_blocked_sha256":
            "832626d9cf6d146fe43cd76c7efada14b86658369ef1b49171cbe2d78a672768",
        "correction_scope":
            "mktemp-directory plus absent environment.json child path",
