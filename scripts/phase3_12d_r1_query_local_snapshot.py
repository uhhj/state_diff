...
def run_query(spec: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    query_row: Dict[str, Any] = {
        ...
        "failure_reason": "",
        "scope": "phase3_12d_r1_query_local_snapshot_no_phase4_no_cps",
    }
...
def main() -> None:
    ...
    parser.add_argument(
        "--out-query-csv",
        default="reports/phase3_12d_r1_queries.csv",
    )
    parser.add_argument(
        "--out-candidate-csv",
        default="reports/phase3_12d_r1_candidate_effects.csv",
    )
    parser.add_argument(
        "--progress-json",
        default="reports/phase3_12d_r1_progress.json",
    )
    parser.add_argument(
        "--out-json",
        default="reports/phase3_12d_r1_raw_summary.json",
    )
    parser.add_argument(
        "--worker-dir", default="reports/phase3_12d_r1_workers"
    )
