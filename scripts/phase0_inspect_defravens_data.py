...
def main() -> None:
    ...
    md.append("")
    md.append("- DeformableRavens import smoke test passes.")
    md.append("- `cable-line-notarget` is present in `tasks.names`.")
    md.append("- `data/cable-line-notarget` has at least 10 smoke demos.")
    md.append("- `goals/cable-line-notarget` has at least 20 goals.")
    md.append("- `reports/phase0_defravens_summary.json` exists.")
    md.append("- `reports/phase0_defravens_setup.md` exists.")
    md.append("- Visualization videos or images are not required for Phase0.")
