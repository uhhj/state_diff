#!/usr/bin/env python3
"""Write-once blocked evidence for r2.5.4 Resume2."""
...
def main() -> None:
    ...
    summary_path = root / RESUME2_BLOCKED_SUMMARY_PATH
    report_path = root / RESUME2_BLOCKED_REPORT_PATH
    if summary_path.exists() or report_path.exists():
        raise RuntimeError("refusing to overwrite Resume2 blocked evidence")

    preflight = root / RESUME2_PREFLIGHT_PATH
    pilot = root / RESUME2_PILOT_PATH
