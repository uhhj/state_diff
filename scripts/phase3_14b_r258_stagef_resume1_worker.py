#!/usr/bin/env python3
"""Isolated Stage-F Resume1 worker."""
...
def main() -> None:
            ...
            json.dumps(
                {
                    ...
                    "required_operation_pass": result["required_operation_dry_run"][
                        "pass"
                    ],
                    "output": str(output),
                },
    ...
    temporary_root = Path(
        tempfile.mkdtemp(prefix="phase314b_r258_stagef_resume1_", dir="/tmp")
    )
    ...
    try:
        ...
        result["resume1_translation_fix"] = {
            "phase": "Phase3.14b-r2.5.8 Stage F Resume1",
            "structural_float64_gate": True,
            "componentwise_float32_gate": True,
