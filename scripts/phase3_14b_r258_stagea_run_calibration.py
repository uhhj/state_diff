#!/usr/bin/env python3
"""Run two isolated r2.5.8 Stage-A workers and seal evidence."""
...
def render_report(
    ...
    lines = [
        "# Phase3.14b-r2.5.8 Stage A — Hardware-Portable Conflict Projection",
        "",
...
def main() -> None:
    ...
    worker_evidence = {
        "phase": PHASE,
        "schema":
            "phase314b_r258_stagea_portable_worker_evidence_v2",
        "worker_count": 2,
        "workers_exact": True,
    ...
    summary = {
        "phase": PHASE,
        "schema":
            "phase314b_r258_stagea_portable_summary_v2",
        "verdict": "PASS",
