...
def main() -> None:
    ...
    compile_targets = [
        ...
        root / "scripts/phase3_14b_r258_stagef_resume3_worker.py",
        root / "scripts/phase3_14b_r258_stagef_resume3_run_calibration.py",
        root / "scripts/phase3_14b_r258_stagef_resume3_test_gate.py",
    ...
    subprocess.run(
        ["bash", "-n", str(root / "scripts/phase3_14b_r258_stagef_resume3_run.sh")],
        cwd=str(root),
        check=True,
    )
