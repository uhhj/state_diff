#!/usr/bin/env python3
"""Write-once blocked evidence for Stage-D Resume2."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=(
            "reports/"
            "phase3_14b_r258_staged_resume2_"
    ...
    payload = {
        ...
        "schema":
            "phase314b_r258_staged_resume2_blocked_v1",
        "verdict":
            "BLOCKED",
        "scientific_status":
            "BLOCKED",
        "root_cause": (
            "phase314b_r258_staged_resume2_"
        ...
        "stage_d_implementation_commit":
            "539521776dd515fac11a84396d3664ce44f31017",
        "stage_d_blocked_provenance_commit":
