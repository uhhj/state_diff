...
def main() -> None:
    ...
    parser.add_argument("--query-csv", default="reports/phase3_12d_r2_queries.csv")
    parser.add_argument("--candidate-csv", default="reports/phase3_12d_r2_candidate_effects.csv")
    parser.add_argument("--progress-json", default="reports/phase3_12d_r2_progress.json")
    parser.add_argument("--raw-json", default="reports/phase3_12d_r2_raw_summary.json")
    parser.add_argument("--environment-audit", default="reports/phase3_12d_r2_environment_audit_summary.json")
    ...
    parser.add_argument("--out-json", default="reports/phase3_12d_r2_summary.json")
    parser.add_argument("--out-md", default="reports/phase3_12d_r2_report.md")
    parser.add_argument("--out-query-summary-csv", default="reports/phase3_12d_r2_query_headroom.csv")
    parser.add_argument("--out-family-summary-csv", default="reports/phase3_12d_r2_family_summary.csv")
