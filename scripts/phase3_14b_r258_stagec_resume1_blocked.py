#!/usr/bin/env python3
"""Write-once blocked evidence for Stage-C Resume1."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=(
            "reports/"
            "phase3_14b_r258_stagec_resume1_"
    ...
    payload = {
        ...
        "schema":
            "phase314b_r258_stagec_resume1_blocked_v1",
        "verdict": "BLOCKED",
        "scientific_status": "BLOCKED",
        "root_cause": (
            "phase314b_r258_stagec_resume1_"
        ...
        "first_attempt_test_gate_preserved":
            (root / (
                "reports/"
                "phase3_14b_r258_stagec_test_gate_summary.json"
            )).is_file(),
        "first_attempt_blocked_preserved":
            (root / (
                "reports/"
                "phase3_14b_r258_stagec_blocked_summary.json"
            )).is_file(),
